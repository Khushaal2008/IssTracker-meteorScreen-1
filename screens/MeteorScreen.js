...
import { Alert, StyleSheet, Text, View,Alert } from 'react-native';
...
export default class MeteorScreen extends React.Component{
    ...
    getMeteor = () =>{
        axios.get("https://api.nasa.gov/neo/rest/v1/feed?api_key=tA81lbsBXhNAQNsxlpmHrFnwQFP9gEAQuai7CBoC")
        .then(response=>{
            this.setState({
